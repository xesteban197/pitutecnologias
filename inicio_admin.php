...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <h2 class="text-center all-tittles" style="clear: both; margin: 25px 0;">todo</h2>
        </a>    
        <div class="container">
            <div class="row">
       ...
       <form>
        <?php     
                       if(@$_GET["nombre"] != ""){
                        ...
                        $sql = "Select * from producto where estado >= 1 ORDER BY RAND()";
                        }
                        ...
                        if(!$resultado){
                            ...
                            while($fila=mysqli_fetch_assoc($resultado)){
                              ?>  
                                ...
                                <td>
                                <h4 class='card-title'>
                                <a href='producto_admin.php?id_producto=<?php echo "$fila[id_producto]"?>'> 
