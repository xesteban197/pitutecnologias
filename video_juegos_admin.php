...
<body>
    <div class="navbar-lateral full-reset">
        ...
        <a href="inicio.php">
        <h2 class="text-center all-tittles" style="clear: both; margin: 25px 0;">VIDEO JUEGOS</h2>
        </a>    
        <div class="container">
            <div class="row">
       ...
       <form>
        <?php     
                       if(@$_GET["nombre"] != ""){
                        ...
                        $sql = "Select * from producto where estado = 1 AND id_categoria = 14 ORDER BY RAND()";
                        }
