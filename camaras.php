...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <a href="inicio.php">
        <h2 class="text-center all-tittles" style="clear: both; margin: 25px 0;">CAMARAS Y ACCESORIOS</h2>
        </a>    
        <div class="container">
            <div class="row">
       ...
       <form>
        <?php     
                       if(@$_GET["nombre"] != ""){
                        ...
                        $sql = "Select * from producto where estado = 1 AND id_categoria = 7 ORDER BY RAND()";
                        }
