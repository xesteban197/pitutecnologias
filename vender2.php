...
<div class="navbar-lateral full-reset">
        ...
        <div class="conteiner-fluid">
            <ul class="nav nav-tabs nav-justified" style="font-size: 17px;">
                <li  class="title-flat-form "><h2>Vender</h2></li>
                <br></br>
        ...
        <form  action='inicio_admin.php' autocomplete="off">
        <button class="btn btn-primary" ><i class="zmdi zmdi-undo"></i> &nbsp;&nbsp; regresar a la lista</button>
        </form>
        <div class="container-fluid">
            <div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">Vender producto</div>
                <form class="form-horizontal" method="POST" action="validar_venta.php" autocomplete="off">
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                       <div class="group-material">
                                <input type="hidden" class="material-control tooltips-general" name="estado" maxlength="70"  
                                value="<?php echo $_GET['estado']?>">
                           ...
                           <div>
                           <h2>seleccione la cantidad que desea vender</h2>
                           </div>
                           <br></br>
