            ...
            <div class="full-reset nav-lateral-list-menu">
                <ul class="list-unstyled">
                    ...
                    <li>
                        ...
                        <li><a href="ventas_clientes.php"><i class="zmdi zmdi-accounts-alt zmdi-hc-fw"></i>&nbsp;&nbsp; Ventas clientes</a></li>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container-fluid">
            <div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">editar proceso</div>
                <form class="form-horizontal" method="POST" action="editar_proceso.php" autocomplete="off">
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                       <div class="group-material">
                                <input type="hidden" class="material-control tooltips-general" name="id_venta" maxlength="70"  
                                value="<?php echo $_POST['id_venta']?>">
                            ...
                            <div class="group-material">        
                        estado
                        <select type="text" class="material-control tooltips-general" name="estado" required="" maxlength="50">
                            
                                <option value='6'>en espera</option>                       
                                <option value='2'>en despacho</option>
                                <option value='3'>enviado</option>
                                <option value='4'>entregado</option>
                                <option value='5'>en devolucion</option>
                        ...
                        <span class="highlight"></span>
                            ...
                            <p class="text-center">
                                <button type="submit" class="btn btn-primary"><i class="zmdi zmdi-floppy"></i> &nbsp;&nbsp; guardar estado</button>
                            </p>
                        </div>
                    </div>
                </form>
