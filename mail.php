...
$repass = $_POST['repass'];
    ...
    header("location:registrar_usuario.php?nombre=$nombre&apellidos=$apellidos&documento=$documento&correo=$correo&pass=$pass&telefono=$telefono&ciudad=$ciudad&direccion=$direccion&torre=$torre&apto=$apto&casa=$casa&repass=$repass");
