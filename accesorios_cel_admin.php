...
<body>
    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <a href="accesorios_cel_admin.php">
        <h2 class="text-center all-tittles" style="clear: both; margin: 25px 0;">ACCESORIOS PARA CELULARES</h2>
        </a>    
        <div class="container">
            <div class="row">
       ...
       <form>
        <?php     
                       if(@$_GET["nombre"] != ""){
                        $sql = "Select * from producto where nombre LIKE '%$_GET[nombre]%' AND estado >= 1 AND id_categoria = 3 ";
                        }
                        else{
                        $sql = "Select * from producto where estado >= 1 AND id_categoria = '3'ORDER BY RAND()";
                        }
                        ...
                        if(!$resultado){
                            ...
                            while($fila=mysqli_fetch_assoc($resultado)){
                              ?>  
                                ...
                                <form method='POST' action='producto_editar.php'>
                        ...
                        <input type='hidden' name='imagen1' value='<?php echo "$fila[imagen1]" ?>'>
                        <input type='hidden' name='imagen2' value='<?php echo "$fila[imagen2]" ?>'>
                        <input type='hidden' name='imagen3' value='<?php echo "$fila[imagen3]" ?>'>
                        <input type='hidden' name='imagen4' value='<?php echo "$fila[imagen4]" ?>'>
                        <input type='hidden' name='imagen5' value='<?php echo "$fila[imagen5]" ?>'>
                        <input type='hidden' name='imagen6' value='<?php echo "$fila[imagen6]" ?>'>
                        <button type="submit" value="actualizar" class="btn btn-primary"><i class='zmdi zmdi-refresh'></i> &nbsp;&nbsp; editar</button>         
                        </form>
                        <form method='POST' action='eliminar_producto.php'>
                        <input type='hidden' name='id_producto' value=<?php echo"$fila[id_producto]"?>>
                        <button type="submit" value="actualizar" class="btn btn-primary"><i class='zmdi zmdi-delete'></i> &nbsp;&nbsp; eliminar</button>
                        </form>
                        </div>
                                <?php
