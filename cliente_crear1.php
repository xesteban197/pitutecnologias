    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container-fluid">
            <div class="container-flat-form">
                ...
                <form class="form-horizontal" method="POST" action="editar_usuario.php" autocomplete="off">
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                       <div class="group-material">
                                <input type="hidden" class="material-control tooltips-general" name="id_user" required="" maxlength="70" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,70}" data-toggle="tooltip" data-placement="top" title="Escribe tus nombres" 
                                value="<?php echo $_POST['id_usuario']?>">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                               
                            </div>    
                       <div class="group-material">
                                <input type="text" class="material-control tooltips-general" name="nombres_user" placeholder="Nombres" required="" maxlength="70" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,70}" data-toggle="tooltip" data-placement="top" title="Escribe tus nombres"
                           ...
                           <div class="group-material">
                                <input type="text" class="material-control tooltips-general" name="apellidos_user" placeholder="Apellidos" required="" maxlength="70" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,70}" data-toggle="tooltip" data-placement="top" title="Escribe tus apellidos"
                           ...
                           <div class="group-material">
                            <input type="text" class="material-control tooltips-general" name="documento_user" placeholder="Contraseña" required="" maxlength="200" data-toggle="tooltip" data-placement="top" title="Escribe una contraseña"
                            ...
                            <div class="group-material">
                                <input type="email" class="material-control tooltips-general" name="correo_user" placeholder="E-mail"  required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe el Email del administrador"
                            ...
                            <div class="group-material">
                                <input type="password" class="material-control tooltips-general" name="pass_user" placeholder="Contraseña" required="" maxlength="200" data-toggle="tooltip" data-placement="top" title="Escribe una contraseña"
                           ...
                           <div class="group-material">
                            <input type="text" class="material-control tooltips-general" name="telefono_user" placeholder="Telefono" required="" maxlength="200" data-toggle="tooltip" data-placement="top" title="Escribe una contraseña"
                        ...
                        <div class="group-material">        
                        Ciudad
                        <select class="material-control tooltips-general" name="ciudad_user" placeholder="Subcategoria"  required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="selecciona una subcategoria"
                        >
                        <?php     
                        ...
                        if(!$resultado){
                            ...
                            while($fila=mysqli_fetch_assoc($resultado)){
                                if($_POST["id_ciudad"]==$fila["id_ciudad"]){
                                    echo "
                                    <option value= '$fila[id_ciudad]' selected>$fila[nombre]</option>
                                    ";      
                                }
                                echo "
                        ...
                        <div class="group-material">
                            <input type="text" class="material-control tooltips-general" name="direccion_user" placeholder="Direccion" required="" maxlength="200" data-toggle="tooltip" data-placement="top" title="Escribe una contraseña"
                        ...
                        <div class="group-material">
                            <input type="text" class="material-control tooltips-general" name="torre_user" placeholder="Torre" maxlength="200" data-toggle="tooltip" data-placement="top" title="Escribe una contraseña"
                            value="<?php echo $_POST['torre']?>">
                            <span class="highlight"></span>
                            <span class="bar"></span>
                            <label>Torre</label>
                        </div>
                        <div class="group-material">
                            <input type="text" class="material-control tooltips-general" name="apto_user" placeholder="Apto" maxlength="200" data-toggle="tooltip" data-placement="top" title="Escribe una contraseña"
                            value="<?php echo $_POST['apto']?>">
                            <span class="highlight"></span>
                            <span class="bar"></span>
                            <label>Apto</label>
                        </div>
                        <div class="group-material">
                            <input type="text" class="material-control tooltips-general" name="casa_user" placeholder="Casa" maxlength="200" data-toggle="tooltip" data-placement="top" title="Escribe una contraseña"
