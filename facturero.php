    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container">
            <div class="page-header">
              <h1 class="all-tittles">FACTUREROS</small></h1>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">GENERAR FACTURA</div>
                <form class="form-horizontal" method="POST" action="guardar_venta.php" autocomplete="off">
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <div class="group-material">
                                <input type="text" class="material-control tooltips-general" name="nombre" placeholder="Nombres" required="" maxlength="70" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,70}" data-toggle="tooltip" data-placement="top" title="Escribe loss nombres del comprador">
                           ...
                           <div class="group-material">
                            <input type="text" class="material-control tooltips-general" name="documento" placeholder="Documento" required="" maxlength="200" data-toggle="tooltip" data-placement="top" title="Escribe una contraseña">
                            <span class="highlight"></span>
                            <span class="bar"></span>
                            <label>DOCUMENTO</label>
                            </div>
                           <div class="group-material">
                            <input type="text" class="material-control tooltips-general" name="direccion" placeholder="Direccion" maxlength="200" data-toggle="tooltip" data-placement="top" title="Escribe un numero de relefono">
                            <span class="highlight"></span>
                            <span class="bar"></span>
                            ...
                            <div class="group-material">
                            <input type="text" class="material-control tooltips-general" name="ciudad" placeholder="Ciudad" required="" maxlength="200" data-toggle="tooltip" data-placement="top" title="Escribe un numero de relefono">
                            <span class="highlight"></span>
                            <span class="bar"></span>
                            <label>CIUDAD</label>
                            </div>
                            <div class="group-material">
                                <input type="number" class="material-control tooltips-general" name="cantidad" placeholder="Cantidad"  required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe el Email del administrador">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>CANTIDAD</label>
                            </div>
                            <div class="group-material">
                                <input type="" class="material-control tooltips-general" name="producto" placeholder="Producto" required="" maxlength="200" data-toggle="tooltip" data-placement="top" title="Escribe una contraseña">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>PRODUCTO</label>
                            </div>
                           <div class="group-material">
                                    <input type="number" class="material-control tooltips-general" name="imei1" placeholder="Identificacion1" required="" maxlength="200" data-toggle="tooltip" data-placement="top" title="Repite la contraseña">
                                <span class="highlight"></span>
                                <span class="bar"></span>
                                <label>IDENTIFICACION1</label>
                           </div>
                           <div class="group-material">
                            <input type="number" class="material-control tooltips-general" name="imei2" placeholder="Identificacion2" maxlength="200" data-toggle="tooltip" data-placement="top" title="Escribe un numero de relefono">
                            <span class="highlight"></span>
                            <span class="bar"></span>
                            <label>IDENTIFICACION2</label>
                        </div>
                           <div class="group-material">
                            <input type="number" class="material-control tooltips-general" name="precio" placeholder="Precio" required="" maxlength="200" data-toggle="tooltip" data-placement="top" title="Escribe un numero de relefono">
                            <span class="highlight"></span>
                            <span class="bar"></span>
                            <label>PRECIO</label>
                        </div>
                        <div class="group-material">
                            <input type="text" class="material-control tooltips-general" name="valor_letras" placeholder="Total en letras" required="" maxlength="200" data-toggle="tooltip" data-placement="top" title="Escribe una contraseña">
                            <span class="highlight"></span>
                            <span class="bar"></span>
                            <label>TOTAL EN LETRAS</label>
                        </div>
                        <div class="group-material">
                            <input type="text" class="material-control tooltips-general" name="observaciones" required="" placeholder="Observaciones" maxlength="500" data-toggle="tooltip" data-placement="top" title="Escribe una contraseña">
                            <span class="highlight"></span>
                            <span class="bar"></span>
                            <label>OBSERVACIONES</label>
                        </div>
                        <div class="group-material">
                            <input type="number" class="material-control tooltips-general" name="valor_envio" required="" placeholder="Costo de envio" maxlength="500" data-toggle="tooltip" data-placement="top" title="Escribe una contraseña">
                            <span class="highlight"></span>
                            <span class="bar"></span>
