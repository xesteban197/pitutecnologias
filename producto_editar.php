    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container-fluid">
            <div class="container-flat-form">
                <div class="title-flat-form title-flat-blue">editar producto</div>
                <form class="form-horizontal" method="POST" action="editar_producto.php" autocomplete="off" enctype="multipart/form-data">
                    <div class="row">
                       <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                       <div class="group-material">
                                <input type="hidden" class="material-control tooltips-general" name="id_producto" required="" maxlength="70"
                       ...
                       <div class="group-material">
                           ...
                           <div class="group-material">
                                <input type="text" class="material-control tooltips-general" name="precio"  maxlength="100" 
                           ...
                           <div class="group-material">
                            <input type="text" class="material-control tooltips-general" name="descripcion" maxlength="200" 
                            ...
                            <div class="group-material">        
                        categoria
                        <select class="material-control tooltips-general" name="id_categoria" placeholder="Subcategoria"  required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="selecciona una subcategoria"
                        >
                        <?php     
                        ...
                        if(!$resultado){
                            ...
                            while($fila=mysqli_fetch_assoc($resultado)){
                                if($_POST["id_categoria"]==$fila["id_categoria"]){
                                    echo "
                                    <option value= '$fila[id_categoria]' selected>$fila[nombre]</option>
                                    ";      
                                }
                                echo "
                        ...
                        <div class="group-material">
                            <input type="number" class="material-control tooltips-general" name="estado" maxlength="5" 
                            ...
                            <div class="group-material">
                            <img src="<?php echo $_POST['imagen1']?>" class="img-responsive center-box" style="width:30%;"/>    
                            imagen1        
                           ...
                           <div class="group-material">
                            <img src="<?php echo $_POST['imagen2']?>" class="img-responsive center-box" style="width:30%;"/>    
                            imagen2        
                           ...
                           <div class="group-material">
                            <img src="<?php echo $_POST['imagen3']?>" class="img-responsive center-box" style="width:30%;"/>    
                            imagen3        
                           ...
                           <div class="group-material">
                            <img src="<?php echo $_POST['imagen4']?>" class="img-responsive center-box" style="width:30%;"/>    
                            imagen4        
                           ...
                           <div class="group-material">
                            <img src="<?php echo $_POST['imagen5']?>" class="img-responsive center-box" style="width:30%;"/>    
                            imagen5        
                           ...
                           <div class="group-material">
                            <img src="<?php echo $_POST['imagen6']?>" class="img-responsive center-box" style="width:30%;"/>    
                            imagen6        
