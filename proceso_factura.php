    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <form class="pull-right" style="width: 30% !important;" autocomplete="off">
                <div class="group-material">
                    <input type="text" name="id_venta" style="display: inline-block !important; width: 70%;" class="material-control tooltips-general" placeholder="Buscar productos" required=""  maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe el nombre del producto">
