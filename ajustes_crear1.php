    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <div class="container-fluid" style="margin: 50px 0;">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                    Bienvenido a la sección para administrar los perfiles de Administradores
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row">
                <div class="col-xs-12 lead">
                    <ol class="breadcrumb">
                    <li class="active">perfiles de administrador</li>
                    </ol>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="container-flat-form">
                ...
                <form class="form-horizontal" method="POST" action="editar_admin.php" autocomplete="off">
                    <div class="row">
                        <div class="col-xs-12 col-sm-8 col-sm-offset-2">
                            <legend>Datos del administrador</legend>
                            <br><br>
                            <div class="group-material">
                                <input type="hidden" class="material-control tooltips-general" name="id_admon" required="" maxlength="70" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,70}" data-toggle="tooltip" data-placement="top" title="Escribe tus nombres" 
                            ...
                            <div class="group-material">
                                ...
                                <input type="text" class="material-control tooltips-general" name="nombre_admon" required="" maxlength="70" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,70}" data-toggle="tooltip" data-placement="top" title="Escribe tus nombres" 
                            ...
                            <div class="group-material">
                                <input type="email" class="material-control tooltips-general" name="correo_admon"  required="" maxlength="50" data-toggle="tooltip" data-placement="top" title="Escribe el Email del administrador" 
                            ...
                            <div class="group-material">
                                <input type="password" class="material-control tooltips-general" name="pass_admon" required="" maxlength="200" data-toggle="tooltip" data-placement="top" title="Escribe una contraseña" 
            ...
            <table border=3 style="background-color:#DFF0D8; font-weight:bold;">
                ...
                if (!$resultado) {
                    ...
                    <tr>
                        ...
                        <td>
                        <form method='POST' action='ajustes_crear1.php'>
                        <input type='hidden' name='id' value='$fila[id_admin]'>
                        ...
                        <td>
                        <form method='POST' action='eliminar_admin.php'>
                        <input type='hidden' name='id' value='$fila[id_admin]'>
